...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a style="color: white; background-color: #007BFF; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;" href="add">Add</a>					
                        </div>
                    </div>
                </div>
            ...
            <a href="product"><button type="button" class="btn btn-primary">Back to store</button>
